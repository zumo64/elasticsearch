...
public class SimulateDocumentSimpleResultTests extends ESTestCase {
    ...
    public void testSerialization() throws IOException {
        ...
        if (isFailure) {
            ...
            recursiveEqualsButNotSameCheck(otherSimulateDocumentBaseResult.getIngestDocument().getSourceAndMetadata(),
                    simulateDocumentBaseResult.getIngestDocument().getSourceAndMetadata());
        }
    }
}
