...
public final class TermSuggester extends Suggester<TermSuggestionContext> {
    ...
    @Override
    public TermSuggestion innerExecute(String name, TermSuggestionContext suggestion, ContextIndexSearcher searcher, CharsRefBuilder spare) throws IOException {
